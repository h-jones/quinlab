...
class ZaberControlPanel(wx.Panel):
    ...
    def __init__(self, zaber, *args):
        ...
        self._zaber = ZaberLinearActuator(9)
        ...
        copyright = wx.StaticText(self, label=copyright_str)
        ...
        sizer.Add(self._pos_txt, (3, 0))
        sizer.Add(self._pos_val, (3, 1))
        sizer.Add(copyright, (3, 2), (1, 2))
        self.SetSizer(sizer)
...
if __name__ == '__main__':
    ...
    top = wx.Frame(
        None, title="Zaber Control",
        size=wx.DefaultSize())
    zaber = ZaberControlPanel(top)
    sizer = wx.BoxSizer()
    sizer.Add(zaber, 0, wx.ALL, 5)
    top.SetSizer(sizer)
    topSetWindowStyle(
