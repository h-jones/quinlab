"""Polarization Experiment Automation v 1.0

This module is designed as the main control of the automation,
including augmenting features of the GUI.
...
import csv
import newport_1918c as newportlib
...
power_meter = newportlib.Newport_1918c()
apt_motor = None
...
class AutomationGUI(guilib.PolarizationExperimentGUI):
    ...
    def zero_press(self, evt):
        ...
        """
        try:
            power_meter.write("PM:ZEROSTOre")
    ...
    def update_ui(self, iteration, data):
        ...
        global power_meter
        global apt_motor
        self.set_pow_val(float(power_meter.read_instant_power()[1]))
        ...
        with open(filename, "w", newline='') as output:
            ...
            for i in range(0, num_iter, 1):
                ...
                for j in range(int(start_angle*10),
                    ...
                    time.sleep(1)
                    try:
                        power = float(power_meter.read_instant_power()[1])
